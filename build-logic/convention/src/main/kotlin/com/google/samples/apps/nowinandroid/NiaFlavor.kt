...
// The interstitial flavor is a version with AdMob interstitial ads integrated.
// The banner flavor is a version with AdMob banner ads integrated.
@Suppress("EnumEntryName")
enum class NiaFlavor(val dimension: FlavorDimension, val applicationIdSuffix: String? = null) {
    demo(FlavorDimension.contentType, applicationIdSuffix = ".demo"),
    prod(FlavorDimension.contentType),
    interstitial(FlavorDimension.contentType, applicationIdSuffix = ".interstitial"),
    banner(FlavorDimension.contentType, applicationIdSuffix = ".banner"),
}
